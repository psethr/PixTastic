   ...
   public static void main(String[] args)
    {
        ...
        Scanner f = null;
        String fileUsers = "C:\\Users\\Seth\\Desktop\\CPSC 240\\User.txt";
        String line = "";
    try
    {  
    ...
    catch (IOException e) 
    {
        ...
        Picture pic2 = new Picture(user1, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\cat2.jpg","My cat is the cutest!","blaher","",410);
        Picture pic3 = new Picture(user1, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\umw1.jpg","My school rocks!","blah2","#umw",105);
        Picture pic4 = new Picture(user1, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\food1.jpg","Yum!","blah3","",102);
        Picture pic5 = new Picture(user1, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\football1.jpg","Go football!","blah5","",10);
        ...
        Picture pic11 = new Picture(user2, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\food2.jpg","Food is good!","blah","#food",12);
        Picture pic22 = new Picture(user2, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\car1.jpg","My dream car!","","#never",130);
        Picture pic33 = new Picture(user2, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\homework1.jpg","F@#K school!","blah2","#umw",16);
        Picture pic44 = new Picture(user2, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\gym1.jpg","Pumping iron","","#Swoll",10);
        Picture pic55 = new Picture(user2, LocalDateTime.now(),"C:\\Users\\Seth\\Desktop\\CPSC 240\\Group Project Pictures\\movie1.jpg","I loe movies!","","#Swoll",11);
